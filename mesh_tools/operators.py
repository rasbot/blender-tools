...
def _raycast(context, event):
    """Return (obj, face_index) for the mesh face under the mouse, or (None, -1)."""
...
class PA_OT_PickFace(bpy.types.Operator):
    ...
    bl_options = {'REGISTER'}  # no UNDO — modal operators should not push undo states
...
class PA_OT_AlignPlanes(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        # --- Translate: bring source face center to target face center ---
